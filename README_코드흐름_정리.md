...
| 연속 대화·복합 Task·탐색 모드 복구 | 11 | GPT Task 누락 복구, 분야형 설명 정책 선택 → Profile → 합본 응답, 추천 후 다른 분야 전환, 역순 Task, 대안 목록 전체 제외, 자연어 “조건 없이” 보존 | PASS |

세부 정책·대화 시나리오는 **218/218 PASS**, 전체 회귀 테스트는
**57/57 PASS**입니다.
